/* ----------------------------------------------------------------------
   CollideQCT - independent copy of collide_vss implementation

   This file duplicates the behavior of collide_vss.cpp but renames the
   class to CollideQCT so it can be edited independently later to call
   QCT/ANT routines.
------------------------------------------------------------------------- */
...
CollideQCT::CollideQCT(SPARTA *sparta, int narg, char **arg) :
...
double CollideQCT::vremax_init(int igroup, int jgroup)
{
...
double CollideQCT::attempt_collision(int icell, int np, double volume)
{
...
double CollideQCT::attempt_collision(int icell, int igroup, int jgroup,
                                     double volume)
{
 double fnum = update->fnum;
 double dt = update->dt;
...
int CollideQCT::test_collision(int icell, int igroup, int jgroup,
...
void CollideQCT::setup_collision(Particle::OnePart *ip, Particle::OnePart *jp)
{
...
int CollideQCT::perform_collision(Particle::OnePart *&ip,
                                  Particle::OnePart *&jp,
                                  Particle::OnePart *&kp)
{
...
void CollideQCT::SCATTER_TwoBodyScattering(Particle::OnePart *ip,
                                           Particle::OnePart *jp)
{
  double ua,vb,wc;
  double vrc[3];
...
void CollideQCT::EEXCHANGE_NonReactingEDisposal(Particle::OnePart *ip,
                                                Particle::OnePart *jp)
{
...
void CollideQCT::SCATTER_ThreeBodyScattering(Particle::OnePart *ip,
                                               Particle::OnePart *jp,
                                               Particle::OnePart *kp)
{
...
void CollideQCT::EEXCHANGE_ReactingEDisposal(Particle::OnePart *ip,
                                             Particle::OnePart *jp,
                                             Particle::OnePart *kp)
{
...
double CollideQCT::sample_bl(RanKnuth *random, double Exp_1, double Exp_2)
{
...
double CollideQCT::rotrel(int isp, double Ec)
{
...
double CollideQCT::vibrel(int isp, double Ec)
{
...
void CollideQCT::read_param_file(char *fname)
{
...
int CollideQCT::wordparse(int maxwords, char *line, char **words)
{
  int nwords = 1;
  char * word;
...
double CollideQCT::extract(int isp, int jsp, const char *name)
{
